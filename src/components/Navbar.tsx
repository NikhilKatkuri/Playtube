...
export default function Navbar() {
  ...
  return (
    <header className="min-h-[56] h-[56] w-full bg-white/90 backdrop-blur-3xl sticky top-0 px-1 z-20 sm:px-4 flex items-center justify-between">
      {/* left-side */}
      ...
      <div className="hidden sm:flex items-center gap-4  ">
        {/* search-input */}
        <div className="flex items-center  rounded-full border-[1.5px] h-10 border-black/20 overflow-hidden">
          {/* input --query */}
          <input
            type="text"
            name=""
            ...
            placeholder="search"
            className="md:w-96 lg:w-[28rem] h-full rounded-l-full outline-0 pl-7"
          />
          {/* input --query */}
          ...
          <button
            ...
            className="w-16 bg-stone-100 border-l border-black/30 hover:bg-stone-200/70  h-full"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              ...
              focusable="false"
              aria-hidden="true"
              className="inherit pointer-events-none size-6 mx-auto"
            >
              <path
                clipRule="evenodd"
        ...
        {/* search-input */}
        {/* mic */}
        <Button className="bg-stone-100 hover:bg-stone-200/70">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24"
            viewBox="0 0 24 24"
            ...
            focusable="false"
            aria-hidden="true"
            className="inherit pointer-events-none w-full h-full"
          >
      ...
      <div className="flex items-center gap-2">
        <Button className="sm:hidden bg-stone-100 hover:bg-stone-200/70">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            height="24"
        ...
        <Button
         className="bg-stone-100 hover:bg-stone-200/70 relative"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
